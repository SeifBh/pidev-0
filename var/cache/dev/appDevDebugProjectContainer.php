...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->normalizedIds = array(
            ...
            'fos\\userbundle\\security\\loginmanagerinterface' => 'FOS\\UserBundle\\Security\\LoginManagerInterface',
        );
        ...
        $this->aliases = array(
            'FOS\\UserBundle\\Security\\LoginManagerInterface' => 'fos_user.security.login_manager',
    ...
    {
        $this->services['AppBundle\Controller\DefaultController'] = $instance = new \AppBundle\Controller\DefaultController();
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('fos_user.update_email.success', array(0 => function () {
            return ${($_ = isset($this->services['fos_user.listener.flash']) ? $this->services['fos_user.listener.flash'] : $this->get('fos_user.listener.flash')) && false ?: '_'};
        }, 1 => 'addSuccessFlash'), 0);
        $instance->addListener('fos_user.update_email.initialize', array(0 => function () {
            return ${($_ = isset($this->services['fos_user.listener.flash']) ? $this->services['fos_user.listener.flash'] : $this->get('fos_user.listener.flash')) && false ?: '_'};
        }, 1 => 'addInfoFlash'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'pidev5', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\EspritEntreAide\\UserBundle\\Entity'))), 'EspritEntreAide\\UserBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('UserBundle' => 'EspritEntreAide\\UserBundle\\Entity'));
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('EspritEntreAide\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer(${($_ = isset($this->services['swiftmailer.mailer.default']) ? $this->services['swiftmailer.mailer.default'] : $this->get('swiftmailer.mailer.default')) && false ?: '_'}, ${($_ = isset($this->services['router']) ? $this->services['router'] : $this->get('router')) && false ?: '_'}, ${($_ = isset($this->services['templating']) ? $this->services['templating'] : $this->get('templating')) && false ?: '_'}, array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'email_updating.template' => '@FOSUser/Profile/email_update_confirmation.txt.twig', 'from_email' => array('confirmation' => array('belhadjali.seif@gmail.com' => 'Demo'), 'resetting' => array('belhadjali.seif@gmail.com' => 'Demo'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('EspritEntreAide\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('EspritEntreAide\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('EspritEntreAide\\UserBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\EspritEntreAide\\UserBundle/Resources/views'), 'User');
        $instance->addPath(($this->targetDirs[3].'\\src\\EspritEntreAide\\UserBundle/Resources/views'), 'FOSUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1c5978cd3103cb53ca5bf8014b829fcc4e5dc2eb');
    }
    ...
    /**
     * Gets the private '1_fed357bf381d492688b60fcbb7c5b5a0221f5d3c9e4ce1d19012724e137ba01a' shared service.
     *
    ...
    /**
     * Gets the private '2_fed357bf381d492688b60fcbb7c5b5a0221f5d3c9e4ce1d19012724e137ba01a' shared service.
     *
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('As0igyKMbJ', 0, 'KuXlKzYW8lY1gs3eIkDLXs', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ymf58m-6kB', 0, 'KuXlKzYW8lY1gs3eIkDLXs', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SeHuVoFBrN', 0, 'KuXlKzYW8lY1gs3eIkDLXs', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a79e6eb55ff47.85791358');
    }
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'UserBundle' => array(
                    ...
                    'path' => ($this->targetDirs[3].'\\src\\EspritEntreAide\\UserBundle'),
                    'namespace' => 'EspritEntreAide\\UserBundle',
                ),
                'FOSUserBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UserBundle' => 'EspritEntreAide\\UserBundle\\UserBundle',
            ...
            'secret' => '1c5978cd3103cb53ca5bf8014b829fcc4e5dc2eb',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '1c5978cd3103cb53ca5bf8014b829fcc4e5dc2eb',
            ...
            'fos_user.email_update_confirmation.template' => '@FOSUser/Profile/email_update_confirmation.txt.twig',
            'fos_user.storage' => 'orm',
            'fos_user.firewall_name' => 'main',
            'fos_user.model_manager_name' => NULL,
            'fos_user.model.user.class' => 'EspritEntreAide\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'belhadjali.seif@gmail.com' => 'Demo',
            ),
